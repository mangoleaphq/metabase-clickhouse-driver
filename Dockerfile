...
RUN mkdir -p plugins && \
    curl -L -o plugins/clickhouse.metabase-driver.jar https://github.com/ClickHouse/metabase-clickhouse-driver/releases/download/1.4.0/clickhouse.metabase-driver.jar
